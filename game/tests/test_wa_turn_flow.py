...
from game.tests.my_factories import GameSetupWithFactionsFactory, CraftedCardEntryFactory, CardFactory
...
class WATurnFlowTestCase(TestCase):
    ...
    def test_wa_eyrie_emigre_flow(self):
        ...
        CraftedCardEntryFactory(player=self.wa_player, card=emigre_card, used=CraftedCardEntry.UsedChoice.UNUSED)
